...
public class ExtentDemo extends SeleniumUtility {
	...
	public void TestCase1() throws IOException {
		...
		if(getCurrentTitleOfApplication().equals("Google")) {
			test.log(LogStatus.PASS, test.addScreenCapture(screenShot(driver)), "Navigated to the specified URL successfully and page title is also validated");
			//System.out.println("Navigated to the specified URL successfully and page title is also validated");
