...
/**
 * In order handle any JavaScript Pop-up(application specific) we need use driver.switchTo().alert()
 * because java script popup doesn't contain HTML code
 * we use predefind functions of Alert to perform any operation on it
